    ...
    return function (e) {
        ...
        function f(e, t, n) {
            var a = t.currentMonth, r = t.currentYear, i = t.dateSelected, o = t.maxDate, s = t.minDate,
                l = t.showAllDates, d = t.days, c = t.disabledDates, u = t.startDay, h = (t.weekendIndices, t.events),
                f = t.getRange ? t.getRange() : {}, v = +f.start, m = +f.end, y = q(new Date(e).setDate(1)),
                p = y.getDay() - u, D = p < 0 ? 7 : 0;
            y.setMonth(y.getMonth() + 1), y.setDate(0);
            var b = y.getDate(), g = [], w = D + 7 * ((p + b) / 7 | 0);
            w += (p + b) % 7 ? 7 : 0;
            for (var S = 1; S <= w; S++) {
                var M = (S - 1) % 7, x = d[M], j = S - (p >= 0 ? p : 7 + p), C = new Date(r, a, j), Y = h[+C],
                    L = j < 1 || j > b, E = L ? j < 1 ? -1 : 1 : 0, P = L && !l, k = P ? "" : C.getDate(),
                    O = 0 === M || 6 === M, N = v !== m, _ = "qs-square " + x;
            ...
            if (!e.__qs_shadow_dom) {
                ...
                if (!(s && s.isMobile && s.disableMobile)) if ("click" === n) {
                    ...
                    var d = s.calendar, c = s.calendarContainer, h = s.disableYearOverlay, f = s.nonInput,
                        ...
                        p = d.querySelector(".qs-month-year").contains(r), b = r.dataset.monthNum;
                    if (s.noPosition && !l) (c.classList.contains("qs-hidden") ? S : w)(s); else if (o.contains("qs-arrow")) D(o, s); else if (p || o.contains("qs-close")) h || M(!y, s); else if (b) x(e, v, s, b); else {
                        ...
                        if (o.contains("qs-num")) {
                            var g = r.textContent, q = +r.dataset.direction,
        ...
        function O(e, t) {
            var n = q(e), a = this.currentYear, r = this.currentMonth, i = this.sibling;
            ...
            return this.dateSelected = n, t && (this.currentYear = n.getFullYear(), this.currentMonth = n.getMonth(), this.currentMonthName = this.months[n.getMonth()]), p(this.el, this), i && (y({instance: this}), u(i)), (a === n.getFullYear() && r === n.getMonth() || t) && u(this, n), this
        }
        ...
        function I(e, t, n) {
            var a = e.dateSelected, r = e.first, i = e.sibling, o = e.minDate, s = e.maxDate, l = q(t),
                d = n ? "Min" : "Max";
        ...
        t.default = function (e, t) {
            var n = function (e, t) {
                ...
                var y = u === document.body, D = n ? u.parentElement || n : y ? document.body : u.parentElement,
                    b = n ? u.parentElement || l : D, w = document.createElement("div"),
                ...
                if (d.sibling) {
                    var C = d.sibling, Y = x, L = C.minDate || Y.minDate, E = C.maxDate || Y.maxDate;
