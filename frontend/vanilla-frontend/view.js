            ...
            for (let [key, value] of calenderMap) {
                ...
                for (let x = 0; x < timeArray.length; x++){
                    ...
                    if (diffTage > 1){
                        ...
                        let element = createField('Roberto', key, a);
                        row1.appendChild(element);

                        let element1 = createField('Sebi', key, b);
                        row2.appendChild(element1);

                        let element2 = createField('Fredi', key, c);
                        row3.appendChild(element2);

                        let element3 = createField('Susi', key, d);
                        row4.appendChild(element3)
                    }
